		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Plan-Fiili Verimlilik",
									"targetURL": "#combtcplanfiiliverimlilik-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"combtcplanfiiliverimlilik-display": {
								"semanticObject": "combtcplanfiiliverimlilik",
								"action": "display",
								"description": "Plan-Fiili Verimlilik",
								"title": "Plan-Fiili Verimlilik",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.btc.planfiiliverimlilik",
									"url": sap.ui.require.toUrl("com/btc/planfiiliverimlilik")
								}
							}
						}
					}
